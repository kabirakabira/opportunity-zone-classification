...
colnames(level3.data) <- column.names
...
## Drop rows with NAs
## Note: 1,522 rows dropped due to incomplete data
level3.data <- level3.data[complete.cases(level3.data),]

## Write out Data
write.csv(level3.data,
          "data/processed/Level3Data_Clean.csv",
          row.names = F)